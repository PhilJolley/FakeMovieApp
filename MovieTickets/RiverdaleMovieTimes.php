  ...
  <div class='row'>
    <div class='col-sm-4'>
      <div class="list-group">
        ...
        <a href="ItMovieTimes.php" id="MovieList" class="list-group-item">It</a>
        <a href="FridayMovieTimes.php" id="MovieList" class="list-group-item">Friday Night Lights</a>
        <a href="RiverdaleMovieTimes.php" id="MovieList" class="list-group-item active">Riverdale</a>
      </div>
    </div>
        ...
        <div class="thumbnail">
          <div class="caption">
            ...
            <div class="form-group">
              ...
              <button class="btn btn-primary" name="time" value="Riverdale at 11:00 am" type="submit">11:00 am</button> <button class="btn btn-primary" name="time" value="Riverdale at 1:30 pm" type="submit">1:30 pm</button> <button class="btn btn-primary" name="time" value="Riverdale at 4:00 pm" type="submit">4:00 pm</button> <button class="btn btn-primary" name="time" value="Riverdale at 6:00 pm" type="submit">6:00 pm</button>
              <button class="btn btn-primary" name="time" value="Riverdale at 9:00 pm" type="submit">9:00 pm</button>
            </div>
          </div>
        </div>
    </div>
