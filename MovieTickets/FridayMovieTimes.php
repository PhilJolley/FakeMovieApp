  ...
  <div class='row'>
    <div class='col-sm-4'>
      <div class="list-group">
        ...
        <a href="FridayMovieTimes.php" id="MovieList" class="list-group-item active">Friday Night Lights</a>
        ...
        <div class="thumbnail">
          <div class="caption">
            ...
            <div class="form-group">
              ...
              <button class="btn btn-primary" name="time" value="Friday at 11:00 am" type="submit">11:00 am</button> <button class="btn btn-primary" name="time" value="Friday at 1:30 pm" type="submit">1:30 pm</button> <button class="btn btn-primary" name="time" value="Friday at 4:00 pm" type="submit">4:00 pm</button> <button class="btn btn-primary" name="time" value="Friday at 6:00 pm" type="submit">6:00 pm</button>
              <button class="btn btn-primary" name="time" value="Friday at 9:00 pm" type="submit">9:00 pm</button>
            </div>
          </div>
        </div>
    </div>
