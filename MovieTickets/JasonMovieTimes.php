  ...
  <div class='row'>
    <div class='col-sm-4'>
      <div class="list-group">
        ...
        <a href="JasonMovieTimes.php" id="MovieList" class="list-group-item active">Jason Bourne</a>
          ...
          <div class="caption">
            ...
            <p>Movie Times</p>
              <div class="form-group">
                ...
                <button class="btn btn-primary" name="time" value="Jason at 11:00 am" type="submit">11:00 am</button> <button class="btn btn-primary" name="time" value="Jason at 1:30 pm" type="submit">1:30 pm</button> <button class="btn btn-primary" name="time" value="Jason at 4:00 pm" type="submit">4:00 pm</button> <button class="btn btn-primary" name="time" value="Jason at 6:00 pm" type="submit">6:00 pm</button>
                <button class="btn btn-primary" name="time" value="Jason at 9:00 pm" type="submit">9:00 pm</button>
              </div>
          </div>
        </div>
    </div>
